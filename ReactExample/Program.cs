...
using ReactExample.Repositories;
using ReactExample.Services.Contracts;
using ReactExample.Services;
using ReactExample;
using System.Text;
...
builder.Services.AddDbContext<VirtualTeacherContext>(options =>
{
    ...
    options.UseSqlServer(connectionString, b => b.MigrationsAssembly(typeof(ReactExample.Data.VirtualTeacherContext).Assembly.FullName));
